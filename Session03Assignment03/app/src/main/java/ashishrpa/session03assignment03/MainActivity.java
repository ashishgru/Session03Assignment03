package ashishrpa.session03assignment03;
...
public class MainActivity extends AppCompatActivity {
    ...
    float principle, rateYearly, min_payment;
    float[] soln;
    @Override
        ...
        bt_compute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(et_enter_card_balace.getText().toString().length()==0) {
                    ...
                    Toast.makeText(MainActivity.this, "enter yearly interst rateYearly", Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    rateYearly = Float.parseFloat((et_enter_yearly_interst_rate.getText()).toString());
                    min_payment = Float.parseFloat(String.valueOf(et_enter_minimum_payment.getText()));
//                    soln = total_floatinterest_payable(principle, rateYearly, min_payment);
...
//                    et_interest_paid_will_be.setText(String.valueOf(soln[0]));
    ...
    private float[] total_floatinterest_payable(float principle, float rateYearly, float minimum_payment){
        ...
        do {
            ...
            count++;
            monthlyfloatInterestPaid = Math.round((principle * (rateYearly / (100 * 12))));// 1
    ...
    private class MyAsyncTask extends AsyncTask<Void, Void, float[]> {
        @Override
        ...
        @Override
        protected void onPostExecute(float[] soln) {
            et_final_card_balance.setText(String.valueOf(soln[1]));
            et_months_remaining.setText(String.valueOf(soln[2]));
            et_interest_paid_will_be.setText(String.valueOf(soln[0]));
        }
